...
var AutoComplete = /** @class */ (function () {
    ...
    AutoComplete.defaults = {
        ...
        _Clear: function () {
            this.Input.value = '';
            this.Input.removeAttribute("data-autocomplete-old-value");
            this.Input.removeAttribute("data-autocomplete-value");
            ...
            try {
                ...
                if (Array.isArray(json)) {
                    ...
                    for (var value in json) {
                        returnResponse.push({
                            "Value": JSON.stringify({ "key" : value, "value" : json[value] }),
        ...
        _Select: function (item) {
            ...
            this.OnSelect(this.Input, this.Input.value);
