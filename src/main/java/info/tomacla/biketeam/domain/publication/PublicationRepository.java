...
@Repository
public interface PublicationRepository extends CrudRepository<Publication, String>, PagingAndSortingRepository<Publication, String>, JpaSpecificationExecutor<Publication> {
