...
public class RideMessageTest extends AbstractDBTest {
    ...
    public void test() {
        ...
        assertEquals(0, rideMessageRepository.findAllByRideId(ride.getId()).size());
        assertEquals(0, rideMessageRepository.findAllByUserId(user.getId()).size());

        rideMessageRepository.save(m);

        assertEquals(1, rideMessageRepository.findAllByRideId(ride.getId()).size());
        assertEquals(1, rideMessageRepository.findAllByUserId(user.getId()).size());
